...
import type { Holiday, HistoricalRun, EmailRun, OptimaRun } from '../historical.types';
...
const MOCK_HISTORICAL_RUNS: HistoricalRun[] = [
  { valuationDate: '01/15/2026', totalCounterparty: 42, startDate: '01/01/2026', endDate: '01/15/2026' },
  { valuationDate: '02/15/2026', totalCounterparty: 38, startDate: '02/01/2026', endDate: '02/15/2026' },
  { valuationDate: '03/15/2026', totalCounterparty: 55, startDate: '03/01/2026', endDate: '03/15/2026' },
];
